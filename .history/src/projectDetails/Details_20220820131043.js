        ...
        <form className='check-form'>
          <div className='row'>
            <div className={` ${checked_1 ? "detail-item-active" : "detail-item"}`}>
              ...
              <label className={`${checked_1 ? "detail-item-paragraph-active" : "detail-item-paragraph"}`}>Sales-Bussiness development Manager, Sales Director, Sales Executive</label>
            </div>
            <div className={` ${checked_2 ? "detail-item-active" : "detail-item"}`}>
              ...
              <label className={`${checked_2 ? "detail-item-paragraph-active" : "detail-item-paragraph"}`}>Sales-Bussiness development Manager, Sales Director, Sales Executive</label>
            </div>
          </div>
          <div className='row'>
            <div className={` ${checked_3 ? "detail-item-active" : "detail-item"}`}>
              ...
              <label className={`${checked_3 ? "detail-item-paragraph-active" : "detail-item-paragraph"}`}>Sales-Bussiness development Manager, Sales Director, Sales Executive</label>
            </div>
            <div className={` ${checked_4 ? "detail-item-active" : "detail-item"}`}>
              ...
              <label className={`${checked_4 ? "detail-item-paragraph-active" : "detail-item-paragraph"}`}>Sales-Bussiness development Manager, Sales Director, Sales Executive</label>
            </div>
          </div>
          <div className='row'>
            <div className={` ${checked_5 ? "detail-item-active" : "detail-item"}`}>
              <input type="checkbox" id="detail_5" name="detail_5" className='detail-check' onClick={handle_5}/>
              <label className={`${checked_5 ? "detail-item-paragraph-active" : "detail-item-paragraph"}`}>Sales-Bussiness development Manager, Sales Director, Sales Executive</label>
            </div>
          </div>
        </form>
