    ...
    return (
        <div className='talents-box'>
          <form className='check-form'>
            <div className='row'>
              <div className={`col-1 ${checked_1%2===1 ? "talent-item-active" : "talent-item"}`} onClick={incrementCount1}>
                <label className={`${checked_1%2===1 ? "talent-item-paragraph-active" : "talent-item-paragraph"}`}>Sales Growth</label>
                <a> { checked_1%2===0 ? <FaPlus id='icon+' size={15}  /> : <FaMinus id='icon-' size={15}  />}</a>
              </div>
              <div className={`col-3 ${checked_2%2===1 ? "talent-item-active" : "talent-item"}`} onClick={incrementCount2}>
                ...
                <a> { checked_2%2===0 ? <FaPlus id='icon+' size={15}  /> : <FaMinus id='icon-' size={15}  />}</a>
              </div>
              <div className={`col-3 ${checked_3%2===1 ? "talent-item-active" : "talent-item"}`} onClick={incrementCount3} >
                ...
                <a> { checked_3%2===0 ? <FaPlus id='icon+' size={15}  /> : <FaMinus id='icon-' size={15}  />}</a>
              </div>
              <div className={`col-4 ${checked_4%2===1 ? "talent-item-active" : "talent-item"}`} onClick={incrementCount4}>
                ...
                <a> { checked_4%2===0 ? <FaPlus id='icon+' size={15}  /> : <FaMinus id='icon-' size={15}  />}</a>
              </div>
            </div>
            <div className='row'>
              <div className={`col-4 ${checked_5%2===1 ? "talent-item-active" : "talent-item"}`} onClick={incrementCount5}>
                ...
                <a> { checked_5%2===0 ? <FaPlus id='icon+' size={15}  /> : <FaMinus id='icon-' size={15}  />}</a>
            </div>
            </div>
          </form>
        </div>
