...
const Talents = ({title}) => {
    ...
    const [checked_2, setCount] = useState(0);
    const incrementCount2 = () => {
        setCount(checked_2 + 1);
    };
    const [checked_3, setCount] = useState(0);
    const incrementCount3 = () => {
    setCount(checked_3 + 1);
    };
    const [checked_4, setCount] = useState(0);
    const incrementCount4 = () => {
        setCount(checked_4 + 1);
    };
    const [checked_5, setCount] = useState(0);
    const incrementCount5 = () => {
        setCount(checked_5 + 1);
        };
    return (
