...
const Talents = ({title}) => {
    ...
    return (
        <div className='talents-box'>
          {title==="Sales"? <form className='check-form'>
            <div className='row'>
          ...
          </form> : title==="Marketing"? <form className='check-form' style={{marginTop: "10px"}}>
            <div className='row'>
              <div className={`${checked_1%2===1 ? "talent-item-active" : "talent-item"}`} onClick={incrementCount1}>
          ...
          </form> : title==="Finance"? <form className='check-form'>
            <div className='row'>
              <div className={`${checked_1%2===1 ? "talent-item-active" : "talent-item"}`} onClick={incrementCount1}>
          ...
          </form> : title==="Development"? <form className='check-form'>
            <div className='row'>
              <div className={`${checked_1%2===1 ? "talent-item-active" : "talent-item"}`} onClick={incrementCount1}>
